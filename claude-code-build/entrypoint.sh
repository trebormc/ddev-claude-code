...
#   2. /host-claude-config/     user's config shared across all DDEV projects
#                               (${HOST_CLAUDE_CONFIG_DIR} on the host)
...
# lower one).
sources=()
for src in "/opt/claude-defaults/settings.json" "/host-claude-config/settings.json"; do
