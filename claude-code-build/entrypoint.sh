...
#   2. /agents-data/settings.generated.json  git-policy PreToolUse hook,
#                                      generated by ddev-agents-sync from the
#                                      per-tool GIT_ALLOW_COMMIT /
#                                      GIT_ALLOW_OPERATIONS flags — only the
#                                      "claude" entry applies here
#                                      (default: block git writes)
